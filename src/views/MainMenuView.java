...
public class MainMenuView {
    ...
    public BorderPane createView() {
        ...
        Button integralesBtn = UIComponents.createContentCard("∫", "Integrales", "Integrales indefinidas y definidas");
        Button practicaBtn = UIComponents.createContentCard("🎯", "Práctica",
                "Ejercicios mixtos para ponerte a prueba");

        funcionesBtn.setOnAction(e -> viewManager.showComingSoon("Funciones"));
        limitesBtn.setOnAction(e -> viewManager.showLimitesMenu());
        derivadasBtn.setOnAction(e -> viewManager.showComingSoon("Derivadas"));
        integralesBtn.setOnAction(e -> viewManager.showComingSoon("Integrales"));
