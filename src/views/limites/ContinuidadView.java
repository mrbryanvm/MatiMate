...
import views.cuestionarios.CuestionarioContinuidadView;

public class ContinuidadView {
    private ViewManager viewManager;
    private LimitesMenuView parentView;

    public ContinuidadView(ViewManager viewManager, LimitesMenuView parentView) {
    ...
    public VBox createView() {
        ...
        Text title = new Text("CONTINUIDAD");
    ...
    private VBox createDefinicionSection() {
        ...
        TextArea definicionText = new TextArea(
                "Una función f(x) es continua en un punto x = a si se cumplen las siguientes tres condiciones:\n\n" +
                        ...
                        "3. lim(x→a) f(x) = f(a) (el límite es igual al valor de la función).\n\n" +
                        "Si alguna de estas condiciones no se cumple, se dice que la función es discontinua en ese punto.\n\n"
                        +
        ...
        definicionText.setPrefHeight(200);
    ...
    private VBox createCuestionarioSection() {
        ...
        Label subTitle = new Label("CONTINUIDAD");
        subTitle.setFont(Font.font("Segoe UI", FontWeight.NORMAL, 14));
        ...
        resolverBtn.setOnAction(e -> {
            CuestionarioContinuidadView cuestionarioView = new CuestionarioContinuidadView(viewManager, this);
            viewManager.getRoot().getChildren().clear();
    ...
    private void reproducirVideo() {
        YouTubePlayer.playVideo(
                ...
                "Video Explicativo - Continuidad en un punto",
                "Aprende cuándo una función es continua en un punto y sus condiciones");
    }
    ...
    private VBox createConceptosSection() {
        ...
        itemBox.setOnMouseClicked(e -> {
            EjerciciosContinuidadView ejerciciosView = new EjerciciosContinuidadView(viewManager, this);
            ejerciciosView.show();
        });
