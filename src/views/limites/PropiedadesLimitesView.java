...
public class PropiedadesLimitesView {
    ...
    private void reproducirVideo() {
        ...
        videoStage.setTitle("Video Explicativo - Propiedades de Límites");
        ...
        Label videoTitle = new Label("Propiedades de Límites - Explicación Completa");
        ...
        Label infoText = new Label("Video explicativo sobre las propiedades de los límites");
