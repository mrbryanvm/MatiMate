...
public class EjerciciosDefinicionView {
    ...
    public VBox createView() {
        ...
        mainContent.getChildren().addAll(
                createExercise(1, "Calcular: lim(x→2) (x² + 3x - 1)", "9"),
                createExercise(2, "Calcular: lim(x→0) (5x + 2)", "2"),
                createExercise(3, "Calcular: lim(x→3) (x² - 9)/(x - 3)", "6"),
                createExercise(4, "Calcular: lim(x→1) (x³ - 1)/(x - 1)", "3"),
                createExercise(5, "Calcular: lim(x→-2) (x² + 4x + 4)/(x + 2)", "0"));
