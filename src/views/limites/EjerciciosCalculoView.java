...
public class EjerciciosCalculoView {
    ...
    public VBox createView() {
        ...
        mainContent.getChildren().addAll(
                ...
                createExercise(2, "Calcular lim(x→3) (x²-9)/(x-3)", "6 (Factorización: (x-3)(x+3)/(x-3))"),
                createExercise(3, "Calcular lim(x→0) (√(x+4)-2)/x", "1/4 (Racionalización)"),
                createExercise(4, "Calcular lim(x→1) (x³-1)/(x-1)", "3 (Factorización: (x-1)(x²+x+1)/(x-1))"),
                createExercise(5, "Calcular lim(x→-2) (x+2)/(x²-4)", "-1/4 (Factorización: (x+2)/((x-2)(x+2)))"));
