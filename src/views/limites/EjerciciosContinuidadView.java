...
public class EjerciciosContinuidadView {
        ...
        public VBox createView() {
                ...
                mainContent.getChildren().addAll(
                                createExercise(1, "Determinar si f(x) = x² + 1 es continua en x = 2",
                                                "Es continua (lim = f(2) = 5)"),
                                createExercise(2, "Determinar si f(x) = (x²-4)/(x-2) es continua en x = 2",
                                                "Discontinua (f(2) no existe)"),
                                createExercise(3, "Determinar si f(x) = |x| es continua en x = 0",
                                                "Es continua (lim = f(0) = 0)"),
                                createExercise(4, "Determinar si f(x) = 1/x es continua en x = 0",
                                                "Discontinua (f(0) no existe)"),
                                createExercise(5,
                                                "Si f(x) = {x+1 si x<2, k si x=2, 3 si x>2}, hallar k para que sea continua",
                                                "k = 3"));
