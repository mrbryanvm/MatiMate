...
import views.LimitesMenuView;
import views.cuestionarios.CuestionarioCalculoView;

public class CalculoLimitesView {
    private ViewManager viewManager;
    private LimitesMenuView parentView;

    public CalculoLimitesView(ViewManager viewManager, LimitesMenuView parentView) {
    ...
    public VBox createView() {
        ...
        mainContent.getChildren().addAll(
                conceptosSection, definicionSection, videoSection, cuestionarioSection);
    ...
    private VBox createDefinicionSection() {
        ...
        Label title = new Label("Métodos de Cálculo");
        title.setFont(Font.font("Segoe UI", FontWeight.BOLD, 18));
        title.setTextFill(AppConstants.TITLE_COLOR);

        TextArea definicionText = new TextArea(
                "Para calcular límites, seguimos estos pasos generales:\n\n" +
                        "1. Sustitución Directa: Es el primer paso. Si la función es continua en el punto, el límite es simplemente f(a).\n\n"
                        +
                        "2. Factorización: Si al sustituir obtenemos 0/0 (indeterminación), intentamos factorizar numerador y denominador para cancelar términos.\n\n"
                        +
                        "3. Racionalización: Si hay raíces cuadradas y obtenemos 0/0, multiplicamos por el conjugado para eliminar la raíz.\n\n"
                        +
                        "4. Simplificación: A veces basta con simplificar la expresión algebraica antes de evaluar el límite.");
        ...
        definicionText.setPrefHeight(220);
    ...
    private VBox createCuestionarioSection() {
        ...
        Label subTitle = new Label("CÁLCULO");
        subTitle.setFont(Font.font("Segoe UI", FontWeight.NORMAL, 14));
        ...
        resolverBtn.setOnAction(e -> {
            CuestionarioCalculoView cuestionarioView = new CuestionarioCalculoView(viewManager, this);
            viewManager.getRoot().getChildren().clear();
    ...
    private void reproducirVideo() {
        YouTubePlayer.playVideo(
                "https://www.youtube.com/watch?v=1j4WOSiVF74",
                "Video Explicativo - Cálculo de Límites",
                "Aprende técnicas para calcular límites: sustitución, factorización y racionalización");
    }
    ...
    private VBox createConceptosSection() {
        ...
        itemBox.setOnMouseClicked(e -> {
            EjerciciosCalculoView ejerciciosView = new EjerciciosCalculoView(viewManager, this);
            ejerciciosView.show();
        });
