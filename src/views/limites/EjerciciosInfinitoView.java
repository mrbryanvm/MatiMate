...
public class EjerciciosInfinitoView {
        private ViewManager viewManager;
        private LimitesInfinitoView parentView;

        public EjerciciosInfinitoView(ViewManager viewManager, LimitesInfinitoView parentView) {
        ...
        public VBox createView() {
                ...
                mainContent.getChildren().addAll(
                                createExercise(1, "Calcular lim(x→∞) (2x² + 3x)/(x² - 1)",
                                                "2 (Grados iguales, coeficientes 2/1)"),
                                createExercise(2, "Calcular lim(x→∞) (x + 1)/(x² + 3)", "0 (Grado num < Grado den)"),
                                createExercise(3, "Calcular lim(x→∞) (3x³ - 2)/(2x² + 5)", "∞ (Grado num > Grado den)"),
                                createExercise(4, "Calcular lim(x→∞) (5x - 1)/(2x + 3)", "5/2 (Grados iguales)"),
                                createExercise(5, "Calcular lim(x→∞) (1/x)", "0"));
