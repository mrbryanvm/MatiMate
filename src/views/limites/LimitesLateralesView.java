...
public class LimitesLateralesView {
    ...
    private void reproducirVideo() {
        ...
        videoStage.setTitle("Video Explicativo - Límites Laterales");
        ...
        Label videoTitle = new Label("Límites Laterales - Explicación Completa");
