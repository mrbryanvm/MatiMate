...
public class EjerciciosLateralesView {
    ...
    public VBox createView() {
        ...
        mainContent.getChildren().addAll(
                createExercise(1, "Calcular: lim(x→2⁺) (x² - 4)/(x - 2)", "4"),
                createExercise(2, "Calcular: lim(x→0⁻) |x|/x", "-1"),
                createExercise(3, "Calcular: lim(x→1⁺) (x - 1)/(x² - 1)", "1/2"),
                createExercise(4, "Calcular: lim(x→3⁻) √(x - 3)", "0"),
                createExercise(5, "Calcular: lim(x→0⁺) 1/x", "+∞"));
