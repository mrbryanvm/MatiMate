...
public class EjerciciosTiposFuncionesView {
    private ViewManager viewManager;
    private TiposFuncionesView parentView;

    public EjerciciosTiposFuncionesView(ViewManager viewManager, TiposFuncionesView parentView) {
    ...
    public VBox createView() {
        ...
        // Header
        VBox header = UIComponents.createHeader("Ejercicios: Tipos de Funciones", "Practica lo aprendido");
        ...
        exercisesContainer.getChildren().addAll(
                createExerciseItem(
                        "Ejercicio 1",
                        "Determina si f(x) = x³ es inyectiva.",
                        "Sí, es inyectiva. Si f(a) = f(b), entonces a³ = b³, lo que implica que a = b. Gráficamente, cualquier línea horizontal corta la gráfica a lo más una vez."),
                createExerciseItem(
                        "Ejercicio 2",
                        "Determina si f(x) = x² es inyectiva.",
                        "No, no es inyectiva. Por ejemplo, f(2) = 4 y f(-2) = 4. Dos valores distintos del dominio tienen la misma imagen."),
                createExerciseItem(
                        "Ejercicio 3",
                        "Clasifica la función f(x) = 2x + 1 de R en R.",
                        "Es una función biyectiva (inyectiva y sobreyectiva). Es una línea recta con pendiente no nula, por lo que cubre todo el rango y no repite valores."),
                createExerciseItem(
                        "Ejercicio 4",
                        "¿Qué tipo de función es f(x) = eˣ?",
                        "Es una función trascendente exponencial. Es inyectiva pero no sobreyectiva si el codominio es R (ya que nunca toma valores negativos o cero)."),
                createExerciseItem(
                        "Ejercicio 5",
                        "¿Qué tipo de función es f(x) = 1/x?",
                        "Es una función racional. Su dominio son todos los reales excepto el 0."));
