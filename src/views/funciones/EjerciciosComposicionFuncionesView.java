...
public class EjerciciosComposicionFuncionesView {
    private ViewManager viewManager;
    private ComposicionFuncionesView parentView;

    public EjerciciosComposicionFuncionesView(ViewManager viewManager, ComposicionFuncionesView parentView) {
    ...
    public VBox createView() {
        ...
        // Header
        VBox header = UIComponents.createHeader("Ejercicios: Composición de Funciones", "Practica lo aprendido");
        ...
        exercisesContainer.getChildren().addAll(
                createExerciseItem(
                        "Ejercicio 1",
                        "Si f(x) = 2x y g(x) = x + 1, calcula (f ∘ g)(x).",
                        "(f ∘ g)(x) = f(g(x)) = f(x + 1) = 2(x + 1) = 2x + 2."),
                createExerciseItem(
                        "Ejercicio 2",
                        "Si f(x) = x² y g(x) = x - 3, calcula (g ∘ f)(x).",
                        "(g ∘ f)(x) = g(f(x)) = g(x²) = x² - 3."),
                createExerciseItem(
                        "Ejercicio 3",
                        "Si f(x) = √x y g(x) = x + 4, halla el dominio de (f ∘ g)(x).",
                        "(f ∘ g)(x) = √(x + 4). El radicando debe ser ≥ 0, entonces x + 4 ≥ 0, x ≥ -4. Dom = [-4, ∞)."),
                createExerciseItem(
                        "Ejercicio 4",
                        "Si f(x) = 1/x y g(x) = x - 1, calcula (f ∘ g)(2).",
                        "Primero g(2) = 2 - 1 = 1. Luego f(1) = 1/1 = 1. Entonces (f ∘ g)(2) = 1."),
                createExerciseItem(
                        "Ejercicio 5",
                        "Si f(x) = x + 1 y g(x) = 2x, ¿es (f ∘ g)(x) igual a (g ∘ f)(x)?",
                        "(f ∘ g)(x) = 2x + 1. (g ∘ f)(x) = 2(x + 1) = 2x + 2. No son iguales, la composición no es conmutativa."));
