...
public class EjerciciosDefinicionFuncionView {
    private ViewManager viewManager;
    private DefinicionFuncionView parentView;

    public EjerciciosDefinicionFuncionView(ViewManager viewManager, DefinicionFuncionView parentView) {
    ...
    public VBox createView() {
        ...
        // Header
        VBox header = UIComponents.createHeader("Ejercicios: Definición de Función", "Practica lo aprendido");
        ...
        exercisesContainer.getChildren().addAll(
                createExerciseItem(
                        "Ejercicio 1",
                        "Determina si la relación f = {(1, 2), (2, 3), (3, 4)} es una función.",
                        "Sí, es una función porque a cada elemento del dominio le corresponde un único elemento del rango."),
                createExerciseItem(
                        "Ejercicio 2",
                        "Dada la relación g = {(1, 2), (1, 3), (2, 4)}, ¿es una función?",
                        "No, no es una función porque al elemento 1 del dominio le corresponden dos valores distintos (2 y 3)."),
                createExerciseItem(
                        "Ejercicio 3",
                        "Si f(x) = 2x + 1, calcula f(3).",
                        "f(3) = 2(3) + 1 = 6 + 1 = 7."),
                createExerciseItem(
                        "Ejercicio 4",
                        "Si h(x) = x², calcula h(-4).",
                        "h(-4) = (-4)² = 16."),
                createExerciseItem(
                        "Ejercicio 5",
                        "Determina si la gráfica de una línea vertical es una función.",
                        "No, porque una línea vertical asigna infinitos valores de y a un solo valor de x (si la línea corta al eje x), o no es una función de x en y."));
